...
export const Card = ({ children, title, subtitle, className = '', headerAction }) => {
  return (
    <div
      className={`bg-slate-900/85 backdrop-blur-md border border-slate-800/80 rounded-2xl p-6 shadow-xl shadow-slate-950/40 transition-all duration-300 hover:border-slate-700/70 ${className}`}
    >
